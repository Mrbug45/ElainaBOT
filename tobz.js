...
• Limit: ${limitCount-updated.limit}`
	...
	//list menu
        ...
        case prefix+'menu':
        case prefix+'list':
           const ppdm = 'https://telegra.ph/file/a2dcb951ccb0933767e97.jpg'
            tobz.sendFileFromUrl(from, `${ppdm}`, 'ppdm.jpg', `
╭──❒ *LIST MENU* ❒───
│
│❒ ${prefix}listdm
│❒ ${prefix}payment
...
`, id)
            break
        case prefix+'listdm':
        const pplist = 'https://telegra.ph/file/a2dcb951ccb0933767e97.jpg'
        tobz.sendFileFromUrl(from, `${pplist}`, 'pplist.jpg', `
╭──❒ *PAYMENT MENU* ❒───
│
│❒ ${prefix}listdm
│❒ ${prefix}payment
...
`, id)
        break
        case prefix+'dana':
        tobz.reply(from, `DANA : 082282007443\n AN/ INDRAWATI JIKA SALAH BUKAN SALAJ ADMIN`, id)
        break
        case prefix+'gopay':
        const ppgopay = 'https://telegra.ph/file/692b3370d37951d1054c7.jpg'
        tobz.sendFileFromUrl(from, `${ppgopay}`, 'ppgopay.jpg', `Scan - Tf - Done`, id)
        break
